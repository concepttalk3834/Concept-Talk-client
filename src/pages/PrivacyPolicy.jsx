...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 mt-24">
      ...
      <p className="mb-4">
        We use your information to authenticate your login, personalize your experience, and maintain basic user records.
        Your information is stored securely and is not shared with third-party services.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">Data Storage</h2>
      <p className="mb-4">
        Your data is securely stored in our database and used only to support your user account. We do not share or sell
        your information.
      </p>
