...
export default function InfiniteScroll({
  ...
  return (
    ...
    >
      {/* Gradient Overlays */}
      <div className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b from-yellow-200 to-transparent z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-pink-200 to-transparent z-10 pointer-events-none"></div>
